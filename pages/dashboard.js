      ...
      >
        ...
        >
          <Heading fontWeight="normal" mb={4} letterSpacing="tight">
            Welcome back, <Flex fontWeight="bold" display="inline-flex">Calvin</Flex>
          </Heading>
          ...
          <Flex justifyContent="space-between" mt={8}>
            <Flex align="flex-end">
              ...
              <Text fontSize="small" color="gray" ml={4}>Sept 2022</Text>
            </Flex>
            <IconButton icon={<FiCalendar/>}></IconButton>
          </Flex>
          <Flex flexDir="column">
            <Flex overflow="auto">
        ...
        >
          ...
          <Flex justifyContent="center" mt={2}>
            <Button bgColor={value == 1 ? "gray.600" : "gray.400"} size="xs" mx={1} onClick={() => setValue(1)} />
            <Button bgColor={value == 2 ? "gray.600" : "gray.400"} size="xs" mx={1} onClick={() => setValue(2)} />
            <Button bgColor={value == 3 ? "gray.600" : "gray.400"} size="xs" mx={1} onClick={() => setValue(3)} />
          </Flex>
